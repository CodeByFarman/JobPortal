  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await emailjs.send(
        'service_rgej2mj',    // EmailJS Service ID (e.g., Gmail)
        'template_zerdc4o',   // EmailJS Template ID
        formData,             // Form data (name, email, telephone, subject, message)
        'pJ0W3OmsJg6qv0-ls'        // EmailJS Public Key (get this from your EmailJS dashboard)
      );
