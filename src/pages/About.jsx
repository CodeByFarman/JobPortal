  ...
  const teamMembers = [
    {
      ...
      role: "CEO",
      imgSrc: "assets/imgs/page/about/marc2.png",
    },
    {
      name: "Amanuddin Shariff",
      role: "HR Manager",
      imgSrc: "assets/imgs/page/about/marc3.png",
    },
    {
      name: "Mohammed Owaise Shariff",
      role: "HR CO-Ordinator",
      imgSrc: "assets/imgs/page/about/marc4.png",
    },
  ];
  const sections = [
    {
      ...
      imgSrc: "assets/imgs/page/about/2965738.jpg",
    },
    {
      title: "Vision",
      content: (
      ...
      imgSrc: "assets/imgs/page/about/AdobeStock_896801651_Preview.jpeg.jpg",
    },
    {
      title: "Mission",
      content: (
      ...
      imgSrc: "assets/imgs/page/about/66.jpg",
    },
    {
      title: "Goals",
      content: (
              ...
              <div className="col-lg-3 col-md-6" key={index}>
                <div className="card-grid-2 wow animate__animated animate__fadeIn">
                  <div className="text-center card-grid-2-image">
                    <a href="#">
                      <figure>
                        <img src={member.imgSrc} alt="jobhub" />
                      </figure>
                    </a>
                  </div>
